...
stringTree (CAT.Node x y left NIL) = (DT.Node (show y) [(stringTree left), (stringTree (NIL))])
stringTree (CAT.Node x y NIL right) = (DT.Node (show y) [(stringTree (NIL)), (stringTree right)])
