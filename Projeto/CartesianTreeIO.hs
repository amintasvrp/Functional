...
stringTree (CAT.Node x y left NIL) = (DT.Node (show y) [(stringTree left), (stringTree (CAT.NIL))])
stringTree (CAT.Node x y NIL right) = (DT.Node (show y) [(stringTree (CAT.NIL)), (stringTree right)])
